<template>
  <q-card class="full-height fixed-full">
    <q-card-section class="q-pa-none bg-green text-white full-height flex justify-center items-center">
      <div class="q-pa-lg text-center">
        <q-icon name="check" color="yellow-7" size="xl"></q-icon>
        <div class="full-width"></div>
        <div class="text-subtitle1 q-my-lg">Payment Success. Your order is preparing.</div>
        <q-btn label="Go to Menu" @click="gotoMenu" color="white" outline></q-btn>
      </div>
    </q-card-section>
  </q-card>
</template>
